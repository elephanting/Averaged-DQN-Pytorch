...
for i in range(1, n_epoch+1):
    ...
    DQN_reward_std.append(np.mean(DQN_reward_tmp))
    ...
    k5_reward_std.append(np.mean(k5_reward_tmp))
    ...
    k10_reward_std.append(np.mean(k10_reward_tmp))
    ...
    DDQN_reward_std.append(np.mean(DDQN_reward_tmp))
    ...
    avg_DDQN_reward_std.append(np.mean(avg_DDQN_reward_tmp))
